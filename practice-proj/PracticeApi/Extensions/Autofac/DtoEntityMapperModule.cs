...
namespace PracticeApi.Extensions.Autofac
{
    /// <summary>
    /// Dto Entity 映射
    /// </summary>
    public class DtoEntityMapperModule : Module
    {
        ...
        public DtoEntityMapperModule(IEnumerable<Assembly> assembliesToScan)
        {
        ...
        /// </summary>
        /// <param name="assembliesToScan"></param>
        public DtoEntityMapperModule(params Assembly[] assembliesToScan) : this(
